...
$router->group(['prefix' => 'student-class'], function () use ($router) {
	...
	$router->get('/student-class/get-class-names', ['as' => 'get-class-names', 'uses' => 'StudentClassController@getClassNames']);			
});
...
// Untuk Class Name
$router->group(['prefix' => 'class-name'], function () use ($router) {
    $router->get('/', ['as' => 'index-class-name', 'uses' => 'ClassNameController@index']);
    $router->get('/create', ['as' => 'create-class-name', 'uses' => 'ClassNameController@create']);
    $router->post('/store', ['as' => 'store-class-name', 'uses' => 'ClassNameController@store']);
    $router->post('/delete', ['as' => 'delete-class-name', 'uses' => 'ClassNameController@delete']);
    $router->post('/get-detail', ['as' => 'detail-class-name', 'uses' => 'ClassNameController@show']);
    $router->post('/update', ['as' => 'update-class-name', 'uses' => 'ClassNameController@update']);
});