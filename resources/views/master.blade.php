...
<head>
    <meta charset="utf-8" />
    <link rel="icon" type="image/png" href="<?= URL::to('/') ?>/layout/assets/img/logo.png">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />

    <title>Monitoring As Salam</title>
    ...
    <script type="text/javascript" charset="utf8" src="<?= URL::to('/') ?>/layout/assets/js/jquery.dataTables.js" defer>
    </script>
