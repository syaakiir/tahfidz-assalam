...
<div class="sidebar-wrapper">
    <div class="logo">
        <img src="<?= URL::to('/layout/assets/img/logo.png') ?>" style="width:110px;height:110px;" class="center">
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input disabled="true" type="text" class="form-control" value="" name="notification_title"
                    ...
                    <div class="form-group">
                        ...
                        <input disabled="true" type="text" class="form-control" value=""
                            name="notification_message" id="notification_message">
                    </div>

                    <div class="form-group">
                        <label>Dikeluarkan Pada Tanggal</label>
                        <input disabled="true" type="text" class="form-control" value="" name="date"
                            id="date">
                    </div>
