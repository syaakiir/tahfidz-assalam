    ...
    <form method="post" action="{{ route('store-siswa') }}">
        ...
        <div class="form-group">
            ...
            @if ($errors->has('siswa_name'))
                <div class="error">
                    <p style="color: red"><span>&#42;</span> {{ $errors->first('siswa_name') }}</p>
                </div>
            @endif
        </div>
        <div class="form-group">
            ...
            <select class="form-control" name="memorization_type">
                <option value="{{ Siswa::TYPE_MURAJAAH }}">Murajaah</option>
                <option value="{{ Siswa::TYPE_HAFALAN }}">Hafalan</option>
            </select>
            @if ($errors->has('memorization_type'))
                <div class="error">
                    <p style="color: red"><span>&#42;</span> {{ $errors->first('memorization_type') }}</p>
                </div>
            @endif
        </div>
        <div class="form-group">
            ...
            @if ($errors->has('class_id'))
                <div class="error">
                    <p style="color: red"><span>&#42;</span> {{ $errors->first('class_id') }}</p>
                </div>
            @endif
        </div>
        <div class="form-group">
